...
Minha formação em Gestão de Negócios, Pessoas e Estética Avançada me permitiu desenvolver habilidades estratégicas em gestão de equipes, treinamento de liderança e tomada de decisões. Com 10 anos de experiência em cargos de liderança, trabalhei na gestão de pessoas, compras, treinamento e soluções para problemas complexos.
...
Python SQL Excel Google Sheets Tableau Power BI Streamlit Dash
